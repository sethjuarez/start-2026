...
- A365 and agent observability

## Sketch 1 - GitHub Copilot App is Awesome
This needs to be couched in an actual app story. "We at [Company X] already had some existing software investments we wanted where we wanted to incorporate this agentic goodness. Since this is an active collection of projects, I thought I would show you how the GHC App can help."
- tour through the copilot app
- start with macro concerns
  - home
  - my work
  - automations
  - Quick chats
- project concerns
  ...
  - rubber duck
  - canvas
  - significant thing to work on (i.e. a skill to bring a copilot studio agent over)
...
What comes after agent optimization? Three levels of Fine Tuning:
- Ground up with your own code + data
